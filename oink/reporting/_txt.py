...
def generate_text_report(from_date, to_date, filepath):
    ...
    with open(filepath, 'w') as fout:
        ...
        # fout.write('\n\n')
        # fout.write(('Generated at ' + report['created_at'] + ' for the momth of ' + report['month'] + '/' + report['year']).center(REPORT_WIDTH))
        # fout.write('\n')
        # fout.write('-' * REPORT_WIDTH + '\n\n')
        #
        # for account_id, account in report['accounts'].items():
        #     fout.write(f'Account: {account["name"]}'.center(REPORT_WIDTH))
        #     fout.write('\n')
        #     fout.write(f'Account #{account["account_number"]}'.center(REPORT_WIDTH))
        #     fout.write('\n\n')
